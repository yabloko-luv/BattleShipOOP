...
namespace WPF_App
{
    ...
    public partial class MainWindow_View : Window
    {
        ...
        private void FadeComboBox_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            Skin theme = e.AddedItems[0] as Skin;
            AppTheme.ChangeTheme(new Uri(theme.ResourceDictionaryPath, UriKind.Relative));
            this.UpdateLayout();
        }
    }
}